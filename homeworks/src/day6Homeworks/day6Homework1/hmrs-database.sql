...
CREATE TABLE public.activation_code_joob_seekers
(
    id integer NOT NULL,
    joob_seeker_id integer NOT NULL,
    PRIMARY KEY (id)
);
...
ALTER TABLE public.activation_code_joob_seekers
    ADD FOREIGN KEY (id)
    REFERENCES public.activation_codes (id)
    NOT VALID;
...
ALTER TABLE public.activation_code_joob_seekers
    ADD FOREIGN KEY (joob_seeker_id)
